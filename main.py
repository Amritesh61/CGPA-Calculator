...
class Main(object):
    ...
    def __init__(self, root):
        ...
        self._labelframe_3 = tkinter.LabelFrame(root,background = "#fafdb3",font = "{Agency FB} 8 italic",foreground = "#000000",text = "S T U D E N T ' S  D E T A I L S",)
        self._frame_1 = tkinter.Frame(root,background = "#FFA555",)
        self._frame_2 = tkinter.Frame(root,background = "#FFA555",)
        self._frame_3 = tkinter.Frame(root,background = "#FFA555",)
        self._frame_4 = tkinter.Frame(root,background = "#FFA555",)
        self._frame_5 = tkinter.Frame(root,background = "#FFA555",)
        self._frame_6 = tkinter.Frame(root,background = "#FFA555",)
        self._frame_7 = tkinter.Frame(root,background = "#FFA555",)
        self._frame_8 = tkinter.Frame(root,background = "#FFA555",)
        self._frame_9 = tkinter.Frame(root,background = "#FFA555",)
        self._frame_10 = tkinter.Frame(root,background = "#FFA555",)
        self._frame_11 = tkinter.Frame(root,background = "#FFA555",)
        self._frame_12 = tkinter.Frame(root,background = "#FFA555",)
        self._frame_13 = tkinter.Frame(root,background = "#FFA555",)
        self._frame_14 = tkinter.Frame(root,background = "#FFA555",)
        self._frame_15 = tkinter.Frame(root,background = "#FFA555",)
        self._frame_16 = tkinter.Frame(root,background = "#FFA555",)
        self._frame_17 = tkinter.Frame(root,background = "#FFA555",)
        self._frame_18 = tkinter.Frame(root,background = "#FFA555",)
        self._frame_20 = tkinter.Frame(root,background = "#FFA555",)
        self._frame_24 = tkinter.Frame(root,background = "#FFA555",)
        self._frame_22 = tkinter.Frame(root,background = "#FFA555",)
        self._frame_23 = tkinter.Frame(root,background = "#FFA555",)
        self._frame_25 = tkinter.Frame(root,background = "#FFA555",)
        self._frame_26 = tkinter.Frame(root,background = "#FFA555",)
        self._frame_27 = tkinter.Frame(root,background = "#FFA555",)
        self._frame_28 = tkinter.Frame(root,background = "#FFA555",)
        self._frame_29 = tkinter.Frame(root,background = "#FFA555",)
        self._frame_30 = tkinter.Frame(root,background = "#FFA555",)
        self._frame_32 = tkinter.Frame(root,background = "#FFA555",)
        self._frame_33 = tkinter.Frame(root,background = "#FFA555",)
        self._frame_34 = tkinter.Frame(root,background = "#FFA555",)
        self._frame_35 = tkinter.Frame(root,background = "#FFA555",)
        self._frame_42 = tkinter.Frame(root,background = "#FFA555",)
        self._frame_43 = tkinter.Frame(root,background = "#FFA555",)
        self._frame_44 = tkinter.Frame(root,background = "#FFA555",)
        self._frame_45 = tkinter.Frame(root,background = "#FFA555",)
        self._frame_46 = tkinter.Frame(root,background = "#FFA555",)
        ...
        self._label_2 = tkinter.Label(root,activebackground = "#16A085",background = "#16A085",font = "{Agency FB} 30 bold",
            text = """LPU CGPA CALCULATOR""",)
        self._label_3 = tkinter.Label(root,activebackground = "#FB9235",background = "#FB9235",font = "{Comic Sans MS} 10 bold",
        ...
        self._label_5 = tkinter.Label(self._labelframe_3,activebackground = "#fafdb3",background = "#fafdb3",font = "{Comic Sans MS} 8 bold",text = "N a m e :",)
        self.name = tkinter.Entry(self._labelframe_3,width = 25,)
        self._label_6 = tkinter.Label(self._labelframe_3,activebackground = "#fafdb3",background = "#fafdb3",font = "{Comic Sans MS} 8 bold",
            text = "    R e g i s t r a t i o n    n u m b e r :",)
        ...
        self._label_12 = tkinter.Label(self._frame_1,activebackground = "#FFA555",activeforeground = "#ff0000",background = "#FFA555",
            font = "{MS Sans Serif} 8 bold",foreground = "#ff0000",text = " First Semester :",)
        self._label_13 = tkinter.Label(root,activebackground = "#B6E7D3",background = "#B6E7D3",font = "{MS Sans Serif} 8 bold",text = "Course Title",)
        self._label_14 = tkinter.Label(root,activebackground = "#B6E7D3",background = "#B6E7D3",font = "{MS Sans Serif} 8 bold",text = "Course Code",)
        self._label_16 = tkinter.Label(root,activebackground = "#B6E7D3",background = "#B6E7D3",font = "{MS Sans Serif} 8 bold",text = "Credit",)
        self._label_20 = tkinter.Label(root,activebackground = "#B6E7D3",background = "#B6E7D3",font = "{MS Sans Serif} 8 bold",text = "Grade Obtained",)
        ...
        self.firsttgpavalue = tkinter.Label(root,
            activebackground = "#FFA555",
            activeforeground = "#ff0000",
            background = "#FFA555",
            font = "{MS Sans Serif} 17 bold",
            foreground = "#ff0000",
            text = 0.00,)
        self._label_22 = tkinter.Label(root,
            activebackground = "#B6E7D3",
            background = "#B6E7D3",
            font = "{MS Sans Serif} 8 bold",
            text = "Grade",)
        self._label_24 = tkinter.Label(root,
            activebackground = "#B6E7D3",
            background = "#B6E7D3",
            font = "{MS Sans Serif} 8 bold",
            text = "Grade Point",)
        self._label_25 = tkinter.Label(root,
            activebackground = "#FBAFFF",
            background = "#FBAFFF",
            font = "{MS Sans Serif} 8 bold",
            text = "O (Outstanding)",)
        ...
        self._label_47 = tkinter.Label(root,
            activebackground = "#FBAFFF",
            background = "#FBAFFF",
            font = "{MS Sans Serif} 8 bold",
            padx = 0,
            pady = 0,
            text = 10,)
        self._label_48 = tkinter.Label(root,
            activebackground = "#FBAFFF",
            background = "#FBAFFF",
            font = "{MS Sans Serif} 8 bold",
            padx = 0,
            pady = 0,
            text = "A+",)
        self._label_49 = tkinter.Label(root,
            activebackground = "#FBAFFF",
            background = "#FBAFFF",
            font = "{MS Sans Serif} 8 bold",
            padx = 0,
            pady = 0,
            text = 9,)
        self._label_50 = tkinter.Label(root,
            activebackground = "#FBAFFF",
            background = "#FBAFFF",
            font = "{MS Sans Serif} 8 bold",
            padx = 0,
            pady = 0,
            text = "A",)
        self._label_51 = tkinter.Label(root,
            activebackground = "#FBAFFF",
            background = "#FBAFFF",
            font = "{MS Sans Serif} 8 bold",
            padx = 0,
            pady = 0,
            text = 8,)
        self._label_52 = tkinter.Label(root,
            activebackground = "#FBAFFF",
            background = "#FBAFFF",
            font = "{MS Sans Serif} 8 bold",
            padx = 0,
            pady = 0,
            text = "B+",)
        self._label_53 = tkinter.Label(root,
            activebackground = "#FBAFFF",
            background = "#FBAFFF",
            font = "{MS Sans Serif} 8 bold",
            padx = 0,
            pady = 0,
            text = 7,)
        self._label_54 = tkinter.Label(root,
            activebackground = "#FBAFFF",
            background = "#FBAFFF",
            font = "{MS Sans Serif} 8 bold",
            padx = 0,
            pady = 0,
            text = "B",)
        self._label_55 = tkinter.Label(root,
            activebackground = "#FBAFFF",
            background = "#FBAFFF",
            font = "{MS Sans Serif} 8 bold",
            padx = 0,
            pady = 0,
            text = 6,)
        self._label_56 = tkinter.Label(root,
            activebackground = "#FBAFFF",
            background = "#FBAFFF",
            font = "{MS Sans Serif} 8 bold",
            padx = 0,
            pady = 0,
            text = "C+",)
        self._label_57 = tkinter.Label(root,
            activebackground = "#FBAFFF",
            background = "#FBAFFF",
            font = "{MS Sans Serif} 8 bold",
            padx = 0,
            pady = 0,
            text = 5,)
        self._label_58 = tkinter.Label(root,
            activebackground = "#FBAFFF",
            background = "#FBAFFF",
            font = "{MS Sans Serif} 8 bold",
            padx = 0,
            pady = 0,
            text = "C",)
        self._label_59 = tkinter.Label(root,
            activebackground = "#FBAFFF",
            background = "#FBAFFF",
            font = "{MS Sans Serif} 8 bold",
            padx = 0,
            pady = 0,
            text = 4,)
        self._label_11 = tkinter.Label(self._frame_24,activebackground = "#B6E7D3",background = "#B6E7D3",font = "{MS Sans Serif} 8 bold",text = "Course Title",)
        self._label_15 = tkinter.Label(self._frame_24,activebackground = "#B6E7D3",background = "#B6E7D3",font = "{MS Sans Serif} 8 bold",text = "Course Code",)
        self._label_17 = tkinter.Label(self._frame_24,activebackground = "#B6E7D3",background = "#B6E7D3",font = "{MS Sans Serif} 8 bold",text = "Credit",)
        self._label_18 = tkinter.Label(self._frame_24,activebackground = "#B6E7D3",background = "#B6E7D3",font = "{MS Sans Serif} 8 bold",text = "Grade Obtained",)
        ...
        self._label_7 = tkinter.Label(root,
            activebackground = "#CFFCEA",
            background = "#CFFCEA",
            font = "{MS Sans Serif} 8 bold",
            text = """PLease find your CGPA and Remarks and
 take steps for improvements""",
        )
        self.open = tkinter.Label(root,
            activebackground = "#FAFDB3",
            background = "#FAFDB3",
            borderwidth = 5,
            font = "{Franklin Gothic Heavy} 12",
            text = "",
        )
        self.save = tkinter.Label(root,
            activebackground = "#fafdb3",
            background = "#FAFDB3",
            borderwidth = 5,
            font = "{Franklin Gothic Heavy} 12",
...
2. Enter your name, reg no. and
course details, then Save it.
...
********************************************************""",
        ...
        root.grid_columnconfigure(3, weight = 0, minsize = 241, pad = 0)
        root.grid_columnconfigure(4, weight = 1, minsize = 158, pad = 0)
        root.grid_columnconfigure(5, weight = 1, minsize = 125, pad = 0)
        root.grid_columnconfigure(6, weight = 1, minsize = 116, pad = 0)
        root.grid_columnconfigure(1, weight = 0, minsize = 5, pad = 0)
        root.grid_columnconfigure(2, weight = 0, minsize = 71, pad = 0)
